...
//----------------------------------------------------------------------------//
        ...
        var hero_lvl = fw.characterParameters.level; //19;

        this.enum_ak = fw.artifacts.sets.types; /* {
            shop:      0,
            hunter:    1,
            event:     2,
            thief:     3,
        ...
        this.enum_as = fw.artifacts.slotTypes; /*{
            right_arm: 0,
            left_arm:  1,
            foots:     2,
            ring:      3,
        ...
        var enum_at =  fw.artifacts.artTypes; /*{
            weapon:  0,
            armor:   1,
            jewelry: 2
        };*/

        var a_prices = fw.artifacts.parameters; /*[
            // shop weapon
...
// NB check it later
        var a_high_durability = fw.artifacts.parameters; /*[
            // shop weapon
        ...
        var a_resources = fw.artifacts.parameters; /*[
            // shop weapon
        ...
        var a_states = fw.artifacts.parameters; /*[
            // shop weapon
        ...
        var a_ex_states = fw.artifacts.parameters; /*[
            // shop weapon
        ...
        var a_unique_states = fw.artifacts.parameters; /*[
            // to be defined
        ];*/
        ...
        this.artefacts = fw.artifacts.parameters; /*[
            // shop weapon
